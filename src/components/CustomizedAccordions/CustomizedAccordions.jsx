      ...
      >
        <AccordionSummary aria-controls='panel1d-content' id='panel1d-header'>
          <Box component='div' sx={{ display: 'flex' }}>
            ...
            <Avatar
              style={{ width: 30, height: 30, marginLeft: '1rem' }}
            ...
            >
              Project Completion Date (Latest Baseline)
            </Typography>
            <Typography
              sx={{
                font: 'normal normal medium 14px/18px Montserrat',
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Typography
                    sx={{ font: 'normal normal 600 16px/20px Montserrat' }}
                  >
                    Project Location
                  </Typography>
                  <Typography
                    sx={{
                      font: 'normal normal 400 14px/27px Montserrat',
                      color: '#3C3838',
                    }}
                  >
                    Locality Sector - 29
